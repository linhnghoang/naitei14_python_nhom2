...
from catalog.models import Author, Publisher, Category, Book, BookAuthor, BookCategory, BookItem
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        author2, _ = Author.objects.get_or_create(
            ...
            defaults={
                'biography': 'British science fiction writer, science writer, futurist, inventor, undersea explorer, and television series host',
        ...
        author3, _ = Author.objects.get_or_create(
            name='Frank Herbert',
            defaults={
                'biography': 'American science fiction author best known for the 1965 novel Dune',
        ...
        author4, _ = Author.objects.get_or_create(
            name='Ray Bradbury',
            defaults={
                'biography': 'American author and screenwriter known for his fantasy, science fiction, horror, and mystery fiction',
        ...
        books_data = [
            {
                'title': 'Foundation',
                'description': 'The first novel in the Foundation series, about a galactic empire in decline',
            ...
            },
            {
                ...
                'description': 'A science fiction novel about human evolution, artificial intelligence, and extraterrestrial life',
            ...
            },
            {
                ...
                'description': 'A dystopian novel about a future society where books are burned',
            ...
            },
            {
                ...
                'description': 'A science fiction detective novel combining the mystery and robot stories',
        ...
        if created_books:
            self.stdout.write(
                self.style.SUCCESS(
                    f'\nSuccessfully created {len(created_books)} books with authors, categories, and items!'
                )
            )
        else:
            self.stdout.write(
